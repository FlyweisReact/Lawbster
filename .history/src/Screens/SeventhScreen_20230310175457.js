      ...
      <div className="seventScreen">
        <div className="left">
          ...
          <div className="seventScreenThird">
            ...
            <p>Got my property issues solved by a lawyer I was put in touch with by MyAdvo's team. I was relieved after I received full refund for possession delay. Smooth and transparent service that I highly recommend!</p>
          </div>
        </div>
