...
<div className='secondScreenBackground'>
      ...
      <div className='right'>
        ...
        <div className='main'>
          ...
          <div>
            ...
            <p className='second'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed dia</p>
          </div>
        </div>
        ...
        <div className='main'>
          <img src={'./Images/33.png'} alt='' style={{height : '41.88px' , width : '35.4px' , marginLeft : '5px'}} />
          <div>
