      ...
      <div className="seventScreen">
        <div className="left">
          ...
          <div className="seventScreenThird">
            ...
            <p className="desc">Got my property issues solved by a lawyer I was put in touch with by MyAdvo's team. I was relieved after I received full refund for possession delay. Smooth and transparent service that I highly recommend!</p>
          </div>  
          ...
          <div className="seventScreenFourth">
            ...
            <div className="twoSec">
              <p > Is RERA applicable to both purchase and rental transactions?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            ...
            <div className="twoSec">
            <p> Will RERA be applicable to existing projects also or only to the future ones?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> Where RERA is not applicable? Are there any exceptions to the Registration of projects under the     
RERA Act?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            ...
            <div className="twoSec">
            <p> What is the right time to file a complaint? Immediately after the agreement expires or should I wait?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p>What is the process of filing a complaint in RERA in case of a delay in handing over the 
possession of the purchased property?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> Can an association of persons file a single complaint under RERA?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> What are the reliefs that I can ask for in my complaint to RERA?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> What is the total compensation expected from the builder through a RERA complaint? What 
interest rate would be payable by the Builder?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> What is the period within which the Regulatory Authority is required to dispose of the complaint?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p>Can the bank from which I have taken a loan to purchase the property be made a party in 
the Complaint?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            <p> How to ensure if your project is Real Estate Regulatory Authority (RERA) compliant?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
            ...
            <div className="twoSec">
            <p> What is RERA number? Where to check the RERA registration number?</p>
              <i class="fa-solid fa-plus"></i>
            </div>
            <div className="twoSec">
