  ...
  return (
    <>
      ...
      <div className="homeFistSec">
        ...
        <p className="desc">400+ Corporates and 27,000+ Customers successfully connected with 10,000+ top Lawyers.</p>
        <div className="two-btn">
          <button style={{color : '#0f2c64' , backgroundColor : 'rgba(15, 44, 100, 0.1)'}}>Sign Up</button>
