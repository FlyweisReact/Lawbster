...
function SignInModal(props) {
  const [ RegisterModalopen ,  RegisterModalCloses ] = useState(true)
  ...
  <RegisterModal show={RegisterModalopen } onHide={() => RegisterModalCloses(false)} />
