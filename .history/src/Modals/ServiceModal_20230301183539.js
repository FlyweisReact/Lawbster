...
function ServiceModal(props) {
    ...
    return (
      ...
      >
        <Modal.Body style={{backgroundColor : 'green' , borderRadius : '20px'}}>
         <div className='ServiceModalTwo'>

                <div className='main'>
                    <p className='head'> Legal Services</p>
                    <p className='desc'>Legal cases with fixed pricing, standardized processes, and firm timelines</p>
                ...
                <div className='main'>
                    ...
                    <p className='desc'>Hassle free government services at affordable prices</p>
